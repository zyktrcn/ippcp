...
void aes_gcm_gettag_128_vaes_avx512(const struct gcm_key_data *key_data,
                                     struct gcm_context_data *context_data,
                                     Ipp8u *auth_tag, Ipp64u auth_tag_len);

#define aes_gcm_gettag_192_vaes_avx512 OWNAPI(aes_gcm_gettag_192_vaes_avx512)
void aes_gcm_gettag_192_vaes_avx512(const struct gcm_key_data *key_data,
                               struct gcm_context_data *context_data,
                               Ipp8u *auth_tag, Ipp64u auth_tag_len);

#define aes_gcm_gettag_256_vaes_avx512 OWNAPI(aes_gcm_gettag_256_vaes_avx512)
void aes_gcm_gettag_256_vaes_avx512(const struct gcm_key_data *key_data,
                               struct gcm_context_data *context_data,
                               Ipp8u *auth_tag, Ipp64u auth_tag_len);
