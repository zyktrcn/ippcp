...
#define ippsRSA_MB_GetBufferSizePublicKey OWNAPI(ippsRSA_MB_GetBufferSizePublicKey)
#define ippsRSA_MB_GetBufferSizePrivateKey OWNAPI(ippsRSA_MB_GetBufferSizePrivateKey)
#define ippsRSA_MB_Encrypt OWNAPI(ippsRSA_MB_Encrypt)
#define ippsRSA_MB_Decrypt OWNAPI(ippsRSA_MB_Decrypt)
#define ippsRSA_MB_Sign_PSS_rmf OWNAPI(ippsRSA_MB_Sign_PSS_rmf)
#define ippsRSA_MB_Verify_PSS_rmf OWNAPI(ippsRSA_MB_Verify_PSS_rmf)
#define ippsRSA_MB_Sign_PKCS1v15_rmf OWNAPI(ippsRSA_MB_Sign_PKCS1v15_rmf)
#define ippsRSA_MB_Verify_PKCS1v15_rmf OWNAPI(ippsRSA_MB_Verify_PKCS1v15_rmf)
